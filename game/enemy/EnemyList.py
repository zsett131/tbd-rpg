...
class EnemyList():
    ...
    Chad = EnemyBasic("Chad", "Boring", 1, player_level, 30, 50, 2, ChadsLoot, 'chad')
    ListofEnemies.append(Chad)

    ChadsLoot = [ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0]]
    Super_Chad = EnemyBasic("Super Chad", "Alpha", 3,  player_level, 30, 50, 2, ChadsLoot, 'mega_chad.png')
    ...
    Bazinga = EnemyBasic("Young Sheldon", "Prezinga.", 1,  player_level, 30, 50, 1, BazingaLoot, 'baby_sheldon.png')
    ...
    Old_Bazinga = EnemyBasic("Sheldon", "Beware of the Bazinga.", 4,  player_level, 40, 50, 3, BazingaLoot, 'sheldon.png')
    ListofEnemies.append(Old_Bazinga)

    BazingaLoot = [ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[1], ConsumableItemsList.consumables[1]]
    Enranged_Bazinga = EnemyBasic("Enranged_Sheldon", "Beware of the Bazinga.", 8,  player_level, 50, 50, 5, BazingaLoot, 'enraged_sheldon.png')
    ...
    enraged_shaggy = EnemyBasic("Angered Shaggy", "ZoinksX2", 7,  player_level, 50, 200, 5, ShaggyLoot, 'enraged_shaggy.png')
    ListofEnemies.append(enraged_shaggy)

    ShaggyLoot = [ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[1], ConsumableItemsList.consumables[1]]
    SSJ_shaggy = EnemyBasic("SSJ Shaggy", "Mega Zoinks", 15,  player_level, 100, 450, 10, ShaggyLoot, 'ssj_shaggy.png')
    ListofEnemies.append(SSJ_shaggy)

    ShaggyLoot = [ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[1], ConsumableItemsList.consumables[1]]
    SSJ_god_shaggy = EnemyBasic("SSJSSJ Shaggy", "MonkaS", 30,  player_level, 250, 1000, 25, ShaggyLoot, 'ssjgod_shaggy.png')
    ListofEnemies.append(SSJ_god_shaggy)

    ShaggyLoot = [ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[0], ConsumableItemsList.consumables[1], ConsumableItemsList.consumables[1]]
    ultra_shaggy_blanco = EnemyBasic("Shaggy Blanco", "....", 55,  player_level, 975, 2785, 69, ShaggyLoot, 'ultra_shaggy_blanco.png')
