...
class TextInput:
    ...
    def __init__(
        ...
        :param repeat_keys_initial_ms: Time in ms before keys are repeated when
        held
        ...
        for event in events:
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pl.K_BACKSPACE:
                    ...
                    # Add one to cursor_pos, but do not exceed
                    # len(input_string)
                    ...
                    self.cursor_position = 0
                        ...
                        self.input_string) < self.max_string_length or \
                        self.max_string_length == -1:
                    # If no special key is pressed, add
                    # unicode of key to input_string
                    self.input_string = (
                            self.input_string[:self.cursor_position]
                            + event.unicode
                            + self.input_string[self.cursor_position:]
                ...
                # *** Because KEYUP doesn't include event.unicode, this dict
                # is stored in such a weird way
